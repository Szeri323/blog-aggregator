...
const truncateFeedFollowsTable = `-- name: TruncateFeedFollowsTable :exec
TRUNCATE TABLE feed_follows CASCADE
`

func (q *Queries) TruncateFeedFollowsTable(ctx context.Context) error {
	_, err := q.db.ExecContext(ctx, truncateFeedFollowsTable)
	return err
}
